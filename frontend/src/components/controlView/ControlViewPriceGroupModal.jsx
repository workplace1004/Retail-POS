...
export function ControlViewPriceGroupModal({
  tr,
  vatOptions,
  showPriceGroupModal,
  ...
  setPriceGroupTax,
  savingPriceGroup,
  handleSavePriceGroup
}) {
  if (!showPriceGroupModal) return null;
        ...
        <div className="p-6 flex flex-col space-y-6 w-full justify-center items-center pt-20">
          <div className='w-full flex flex-col justify-center items-center gap-10'>
            ...
            <div className="flex gap-2 w-full items-center justify-center">
              ...
              <Dropdown
                options={vatOptions.map((o) => ({ ...o, label: tr(`vatOption.${o.value}`, o.label) }))}
                value={priceGroupTax}
